...
public class GolosiChunkGenerator extends NoiseChunkGenerator<GolosiGenSettings> {
	...
	public GolosiChunkGenerator(IWorld worldIn, BiomeProvider provider, GolosiGenSettings settingsIn) {
