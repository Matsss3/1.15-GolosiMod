...
import com.matsss2.golosimod.util.FunctionalIntReferenceHolder;
...
public class OvenContainer extends Container {
	...
	public OvenTileEntity tileEntity;
	private IWorldPosCallable canInteractWithCallable;
	public FunctionalIntReferenceHolder currentSmeltTime;

	// Server Constructor
	public OvenContainer(final int windowID, final PlayerInventory playerInv,
			final OvenTileEntity tile) {
	...
	// Client Constructor
	public OvenContainer(final int windowID, final PlayerInventory playerInv, final PacketBuffer data) {
		this(windowID, playerInv, getTileEntity(playerInv, data));
	}

	private static OvenTileEntity getTileEntity(final PlayerInventory playerInv, final PacketBuffer data) {
		Objects.requireNonNull(playerInv, "playerInv cannot be null");
		Objects.requireNonNull(data, "data cannot be null");
		final TileEntity tileAtPos = playerInv.player.world.getTileEntity(data.readBlockPos());
		if (tileAtPos instanceof OvenTileEntity) {
			return (OvenTileEntity) tileAtPos;
		}
	...
	public boolean canInteractWith(PlayerEntity playerIn) {
		return isWithinUsableDistance(canInteractWithCallable, playerIn, BlockInit.OVEN.get());
	}
