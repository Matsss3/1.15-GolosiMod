...
public class LoomScreen extends ContainerScreen<LoomContainer> {
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      if (this.displayPatternsIn) {
         int l = i + 60;
         int i1 = j + 13;
         int j1 = this.indexStarting + 16;

         for(int k1 = this.indexStarting; k1 < j1 && k1 < BannerPattern.field_222480_O - 5; ++k1) {
            int l1 = k1 - this.indexStarting;
            int i2 = l + l1 % 4 * 14;
            int j2 = i1 + l1 / 4 * 14;
            this.minecraft.getTextureManager().bindTexture(LOOM_GUI_TEXTURES);
            int k2 = this.ySize;
   ...
   private void func_228190_b_(int p_228190_1_, int p_228190_2_, int p_228190_3_) {
      ...
      BannerTileEntityRenderer.func_228837_a_(bannertileentity, matrixstack, irendertypebuffer$impl, 15728880, OverlayTexture.NO_OVERLAY, this.modelRender, ModelBakery.LOCATION_BANNER_BASE, true);
      matrixstack.pop();
